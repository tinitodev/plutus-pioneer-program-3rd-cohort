...
mkValidator ppkh deadline () ctx = traceIfFalse "beneficiary's signature missing" signedByBeneficiary &&
  ...
  where
    ...
    signedByBeneficiary = txSignedBy info $ unPaymentPubKeyHash $ ppkh
